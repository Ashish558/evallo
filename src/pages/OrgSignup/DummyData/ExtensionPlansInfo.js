export const extensionPlansInfo = [
    ...
    },
    {
        ...
        description: [
            "Access Anytime, Anywhere - From scheduling to assignment reports and invoicing to chat/calling, provide easy access to all users via Evallo’s Mobile App.",
    ...
    {
        planName: "Digital_Whiteboards",
        planDisplayName: "Digital Whiteboards (Coming Soon)",
        description: [
            "Scribing & Typing - Directly write on the whiteboard using the Pen tool or type using text boxes.",
            "Upload PDFs - Want to review practice tests and other material? Quickly upload all your documents on the whiteboard and directly type on the PDF files.",
            "Sharing Permissions - Easily share (or hide) whiteboards with your tutors, students & parents, with the ability to add multiple users on a single whiteboard.",
            "Internal Planning - Use digital whiteboards for internal communication, team management, business planning, flowcharts, and much more!",
        ],
        extensionPriceOptionHeadingLabel: "",
        extensionPriceOptionHeadingStatement: "",
        extensionPriceOption: []
