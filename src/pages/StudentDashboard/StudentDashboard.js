    ...
    <div className={`w-[1600px] mx-auto pb-[70px]`} >
      ...
      <div className="flex mt-10 pt-[10px] justify-between">
        <div className=" flex-1 w-[1076px] ">
          ...
          >
            <div className=" absolute top-[30px] right-[30px] max-w-[156px]">
            <InputSelectNew
                placeholder={""}
                parentClassName="ml-0 items-center flex text-[#FFA28D] text-xs border px-1 py-2 border-[#FFA28D] rounded-full"
