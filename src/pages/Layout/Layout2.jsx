...
const Layout2 = ({children}) => {
  ...
  <Navbar myRef={navRef} />
  {/* <div style={{height:layoutParentHeight!==null?`${layoutParentHeight}px`:''}} className='min-h-[calc(100vh-70px)]'> */}
  <div style={{transformOrigin:"top left"}} ref={layoutRef} className='w-[1920px]'>
