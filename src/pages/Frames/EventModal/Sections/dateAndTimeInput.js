  ...
  return (
    <div className="flex mb-[30px] items-end">
      ...
      <InputSelect
        ...
        parentClassName="w-full max-w-[130px] mb-0 "
        type="time"
        optionData={times}
      ...
      />
      <div className="h-[50px] flex justify-center items-center self-end mx-4">
        <svg
          width="13"
          height="2"
          viewBox="0 0 13 2"
      ...
      <InputSelect
        parentClassName="w-full max-w-[130px] self-end"
        type="time"
        placeholderClass="text-[#507CA8]"
      ...
      <InputSelect
        ...
        inputContainerClassName="bg-lightWhite border-0  pl-4 pr-3 pt-3.5 pb-3.5 text-[#507CA8] h-full text-[16px] font-normal"
