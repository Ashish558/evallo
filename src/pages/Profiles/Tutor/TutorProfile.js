            ...
            setToEdit((prevToEdit) => {
              return {
                ...
                serviceSpecializations: {
                  ...
                  isPresent:
                    details === null || details?.serviceSpecializations === null
                      ? false
                      : true,
                },
                videoLink: {
              ...
              <>
                <div className="w-[1313.95px] rounded-md shadow-[0px_0px_2px_0px_#00000040] h-[297.547px] bg-white">
                  <div className="h-[125.519px]  rounded-t-md shadow-t-[0px_0px_2px_0px_#00000040] flex relative bg-[#26435F]">
                    <div className="ml-8  pt-1  w-4/6">
                      <div className="flex h-full  items-end">
                        <div className={isOwn === true || persona === "admin" ? "mb-[-135px] h-min" : "mb-[-112px] h-min"}>
                          <ProfilePhoto
                            isTutor={true}
                            imgSizeClass={"!w-[187.529px] !h-[187.529px]"}
                            className={"!w-[187.529px] !h-[187.529px] "}
                            src={
                              user.photo
                                ? `${awsLink}${user.photo}`
                                : "/images/tutor.jpg"
                    ...
                    {(persona === "student" || persona === "parent") &&
                      organization?.settings?.permissions[2]?.choosedValue && (
                        <div className="ml-auto  mt-[20px] mr-8">
                          <div className="flex gap-[20px] items-center mb-[8px] leading-normal font-normal">
                            <img className="h-[17.95px]" src={mail} alt="mailLogo"></img>
                            <p className="text-white text-[17.503px] text-base-17-5">
                              {user.email}
                            </p>
                          </div>
                          <div className="flex gap-[20px] items-center mb-[8px] leading-normal font-normal">
                            <img className="h-[17.95px]" src={call} alt="callLogo"></img>
                            <p className="text-white text-[17.503px] text-base-17-5">
                              {user.phoneCode}
                              {user.phone}
                            </p>
                          </div>
                          <div className="flex gap-[20px] items-center leading-normal font-normal">
                            <img className="h-[17.95px]" src={linkedin} alt="linkedinLogo"></img>
                            <a
                  ...
                  <div className="flex ml-4 h-[120px] overflow-y-auto">
                    ...
                    <div className="my-[33px] pl-[48px] pr-[41px]">
          ...
          <div className="ml-[26.26px] flex-grow-1 bg-transparent ">
            <div className="flex items-start">
              ...
              <div className="ml-[22.5px]">
                <p className="text-[#24A3D9] font-semibold text-[20px]">
                  Education
                </p>
            ...
            <div className="flex  pl-2 mt-[43.76px] items-start ">
              <img className="mt-[7px]" src={bag} alt="experience"></img>
        ...
        <div className="w-[1600px] relative mt-[65.7px]">
          <div className="w-full grid grid-cols-12 gap-x-[46px]">
                        ...
                        >
                          {isOwn === true || persona === "admin" ? (
                            <span
                              ...
                              className="text-[#517CA8] rounded-md bg-[#38C980] p-2 px-4 text-white text-base-17-5 text-base-17-5 cursor-pointer"
                            >
                              Add Expertise
                            </span>
                          ) : (
            ...
            <div className="col-span-6">
                      ...
                      <div className="absolute z-50 bottom-0 left-0 right-0 top-0 h-full w-full overflow-hidden bg-fixed">
                        <div className="flex h-full mx-auto mt-8  max-w-[80%]  items-center justify-center">
                          <div className="text-[#517CA8]">
                            <p className="mb-4 text-md font-semibold text-[20px]">
              ...
              <div className="relative z-[100] flex justify-between text-xl text-[#26435F] font-semibold text-[20px]">
                <span>Reviews</span>
                    ...
                    {tutorTotalReviews[currentPage - 1] ? (
                      <div>
                        <p className="text-[#24A3D9] text-[15px] text-base-17-5">
                          {tutorTotalReviews[currentPage - 1]?.customCreatedAt
                            ? getDateFormat(
                                tutorTotalReviews[currentPage - 1]
                                  ?.customCreatedAt
                              )
                        ...
                        <div className="flex mt-7 text-[15px]">
                          ...
                          <div>
                            <button className="rounded-full h-[33px] px-[22px] bg-[#26435F33] text-base-15 text-[#26435F]">
                              {tutorTotalReviews[currentPage - 1]?.service[0]}
                            </button>
                          </div>
                        </div>
                      </div>
              ...
              <div className="flex justify-end items-center">
                <Pagination
                  ...
                  totalPages={Math.ceil(tutorTotalReviews?.length)}
                />
              </div>
            </div>
            ...
            <div className={`flex justify-between mt-[55px] gap-x-[37px]  ${persona === "tutor" ? "hidden" : null} `}>
              <div className="w-[1023.744px]">
                <div className="flex items-center mb-1">
                  {(isOwn === true || persona === "admin") && (
                    <>
                      <div className=" text-[#26435F] text-xl font-semibold text-[20px]">
                        Address
                      </div>
                      <p
                    ...
                    <ProfileCard
                      ...
                      body={
                        <div className="flex justify-between px-7 pt-[25px] pb-[24px]">
                          <div className="">
                            <div className="text-[#24A3D9] font-semibold text-[15.002px] text-[20px]">
                              Street Address
                            </div>
              ...
              {persona === "admin" && false && (
                <div className="w-[201.408px]">
                  <div className="flex items-center">
                    <div className="text-xl text-[#26435F] font-semibold text-[20px]">
                      Salary
                    </div>
                    <p
                      className="text-[#667085] ml-auto underline cursor-pointer font-semibold text-[15px] text-base-15"
          ...
          {persona === "admin" && (
            <div className="flex justify-between mt-20 mb-[96px] min-h-[630px]">
              <div className="w-[700.8px]">
                <div className="text-xl text-[#26435F] font-semibold mb-[-10px] text-[20px]">
              ...
              {persona === "admin" && (
                <div className="w-[401.28px] ">
                  <div className="flex items-center">
                    <div className="text-[#26435F] text-[20px] text-[20px] font-semibold">
                      Tutor Status
                    </div>
                    {(isOwn === true || persona === "admin") && (
                      <p
