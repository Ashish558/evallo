    ...
    <div className="flex justify-between">
      <div className="flex flex-col gap-10  w-[68.9vw] design:w-[68vw]">
            ...
            >
              ...
              <div
                className={`${styles["upload-container"]} ${
                  !organization.orgBussinessLogo
                    ? styles["upload-container-centered"]
                    : ""
                } `}
              >
        ...
        <div className="flex flex-1  gap-8 my-3 mb-10 ml-[335px] w-[calc(900*0.0522vw)] min-w-[500px] pb-0">
          <div className="flex flex-col rounded-md shadow-[0px_0px_2.500000476837158px_0px_#00000040]  w-[calc(275*0.0522vw)] min-w-[170px] flex-wrap gap-3 bg-white">
            <h1 className="mt-[-35px]  text-[#26435F] font-medium text-base-17-5 mb-1 text-base-17-5 ">
              Format Of Instructions
            </h1>
            <div className="flex flex-col justify-center items-start px-[25px] pt-[15.002px]">
          ...
          <div className="flex flex-col rounded-md shadow-[0px_0px_2.500000476837158px_0px_#00000040] w-[calc(593*0.0522vw)]  min-w-[370px]  h-[200px] gap-3 bg-white">
            <h1 className=" text-[#26435F] font-medium text-base-17-5  text-base-17-5 mt-[-35px] mb-1">
              Students Served
            </h1>
            <div className="h-full px-[25px] pt-[14.002px] flex flex-col flex-wrap justify-start items-start">
