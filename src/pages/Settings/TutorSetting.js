...
it here. Our team takes every suggestion seriously.'></textarea>   
        ...
        <textarea cols={58} className='rounded text-[#667085] pl-3 pr-3' rows={12} placeholder='If you require technical support, please submit your request here and our team will help you out accordingly.'></textarea>     
        <div className='flex justify-end'>
        <button className='bg-[#517CA8] rounded text-[#FFFFFF] w-[98.7px] h-[48px]' >Submit</button>  
        </div>
            </div>
