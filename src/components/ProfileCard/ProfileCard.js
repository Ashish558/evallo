...
export default function ProfileCard({ title, titleClassName, className, body, hideShadow, bgClassName }) {
   ...
   return (
      <div className={`rounded-5    ${bgClassName ? bgClassName : '  lg:bg-textGray-30'} ${!hideShadow && 'shadow-[0px_0px_2.50039px_0px_rgba(18,17,39,0.25)]'} relative ${className ? className : ''}
      `}>
