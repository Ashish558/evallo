...
export function TableHeaderNew({
  ...
  return dataFor === "assignedTests" ? (
    <th
      className={`pt-[26.25px] pb-[24.25px] text-white text-[17.5px] leading-3 font-medium ${
        ...
        header.text === "Score"
          ? "text-center"
          : " "
      } ${header.text === "Student Name" ? "pl-[40px]" : ""} ${
        header.text === "Assignment Name" ? "text-left pl-8" : ""
      }`}
    >
    ...
    <th
      className={`pt-[26.25px] pb-[24.25px] text-white text-[17.5px] leading-[25px] font-medium ${
    ...
    <th className="text-center py-[18.75px] text-[17.5px] font-medium leading-[21px] text-white">
      <div
        onClick={() => header.onCick && header.onCick()}
        className={`${
...
`}
  ...
  //  data for assigned-students - Tutor Students
  dataFor === "assignedStudents" ? (
    <th className="text-center py-[18.75px] text-[17.5px] font-medium leading-[21px] text-white">
      <div
        onClick={() => header.onCick && header.onCick()}
        className={`flex gap-0 ${header.text === "Student Name" ? "ps-[70px] pr-[129.12px]" : ""}
        
        ${header.text === "Status" ? "justify-center items-center " : ""}
        ${header.text === "Date Assigned" ? "ml-[90px]" : ""}
